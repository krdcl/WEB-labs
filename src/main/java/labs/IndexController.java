...
public class IndexController {
	...
	/*
	RedirectAttributes - класс используется для передачи так называемых flash-атрибутов, 
	то есть, значений, которые будут доступны только следующему запросу 
	и самоликвидируются для последующих запросов
	
	HttpSession - механизм управления состоянием сеанса пользователя, 
